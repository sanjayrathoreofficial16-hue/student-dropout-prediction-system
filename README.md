...
2. Train the model: `python train_model.py` (generates `model.pkl`, `scaler.pkl`, `label_encoder.pkl`)
3. Run the Streamlit app: `streamlit run app.py`
4. For exploration: Open `student-dropout-prediction.ipynb` in Jupyter Notebook and run all cells.
